...
import com.google.mlkit.vision.demo.kotlin.retrieve;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intToHome = new Intent(option.this,gyroscope.class);
        ...
        imgb2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intToHome = new Intent(option.this, retrieve.class);
                startActivity(intToHome);
            }
        });
